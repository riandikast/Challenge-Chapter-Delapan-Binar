...
package com.binar.listmovie.datastore
...
class UserManager (context : Context) {
    ...
    suspend fun saveDataUser(id : String, email:String, password : String, username: String, namalengkap: String, birth: String, address : String, image: String) {
        dataStore.edit {
            it[ID] = id
